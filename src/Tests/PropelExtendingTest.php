...
class PropelExtendingTest extends PropelTestCase
{
    ...
    protected function setUp()
    {
        self::$map = array(
            ...
            'Glorpen\Propel\PropelBundle\Tests\Fixtures\Model\TrianglePerson' =>
                'Glorpen\Propel\PropelBundle\Tests\Fixtures\Model\ExtendedTrianglePerson',
            'Glorpen\Propel\PropelBundle\Tests\Fixtures\Model\SiThing' =>
                'Glorpen\Propel\PropelBundle\Tests\Fixtures\Model\ExtendedSiThing'
        );
    ...
    public function testClassFinder()
    {
        ...
        $this->assertEquals(
            $personModel,
            $finder->findModelClass('Glorpen\Propel\PropelBundle\Tests\Fixtures\Model\ExtendedPeoplePeer')
        );
        $this->assertEquals(
            'Glorpen\Propel\PropelBundle\Tests\Fixtures\Model\TrianglePersonQuery',
            $finder->findQueryClass('Glorpen\Propel\PropelBundle\Tests\Fixtures\Model\ExtendedTrianglePerson'),
            'Extending when using single ineritance'
        );
    ...
    public function testSingleInheritance()
    {
        ...
        $this->assertInstanceOf(
            'Glorpen\Propel\PropelBundle\Tests\Fixtures\Model\ExtendedSiThing',
            SiThingQuery::create()->findPk($p->getPrimaryKey())
        );
    }
    
    //inspiration:
    //https://bitbucket.org/glorpen/glorpenpropelbundle/pull-request/2/change-xpeer-getomclass-to-self-getomclass/diff
